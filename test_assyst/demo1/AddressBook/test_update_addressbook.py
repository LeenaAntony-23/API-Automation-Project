...
def test_create_and_fetch_addressbook_data(customer_id,data,get_addressbook_data_with_customer_id,  field_values, create_client, post_addressbook_data, patch_addressbook_data):
    ...
    data.popitem()
    data.popitem()
    post_address = post_addressbook_data(customer_id, data, 'address_book', False)
    post_address_response = post_address.json()
    common.check_reponse_message(post_address_response,expected_message )
