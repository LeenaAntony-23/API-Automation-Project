...
def test_add_all_data_to_identitytype(customer_id,get_client_data_with_customer_id,data, field_values, create_client, post_client_data, patch_clientidentity_data):
