...
# def test_update_client_name_address_data(customer_id,get_client_data_with_customer_id,data, field_values, create_client, patch_client_data):
#
...
def test_update_client_contact_data(customer_id,get_client_data_with_customer_id,data, field_values, create_client, patch_client_data):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Client/test_data_nationality.csv"))
def test_update_client_nationality_data(customer_id,get_client_data_with_customer_id,data, field_values, create_client, patch_client_data):
...
#
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Client/test_data_personal.csv"))
def test_update_client_personal_data(customer_id,field_values,get_client_data_with_customer_id,data, create_client, patch_client_data):
    ...
    data.popitem()
    #data.popitem()
    #data  = common.read_json("./jsons/create_client_personal.json")
...
#
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Client/test_data_health_note.csv"))
def test_update_client_health_note_data(customer_id,get_client_data_with_customer_id,data, field_values, create_client, patch_client_data):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Client/test_data_administration.csv"))
def test_update_client_administration_data(customer_id,get_client_data_with_customer_id,data, field_values, create_client, patch_client_data):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Client/test_data_compliance.csv"))
def test_update_client_compliance_data(customer_id,get_client_data_with_customer_id,data, field_values, create_client, patch_client_data):
