...
def test_fetch_asset_action_data_with_business_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_asset_data, post_business_data,
                                                  get_business_data_with_action_id):
    ...
    get_action_data = get_business_data_with_action_id(business_id, customer_id)
    ...
    logger.info("Fetch Asset Investment Action Data With Business Id Test Passed!")


@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_mortgage_action_data_with_business_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_liability_data, post_business_data,
                                                     get_business_data_with_action_id):
    ...
    business_id = post_liability_mortage_response['data']['business_id']
    get_action_data = get_business_data_with_action_id(business_id, customer_id)
    get_action_response = get_action_data.json()
    common.check_reponse_message(get_action_response, constants.get_business_case_id_success_message)
    assert get_action_response["isError"] is False
    ...
    common.compare_dicts(post_liability_mortage_response['data'], get_action_response['data'])
    logger.info("Fetch Mortgages Action Data With Business Id Test Passed!")


@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_loan_hire_action_data_with_business_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_liability_data, post_business_data,
                                                      get_business_data_with_action_id):
    ...
    business_id = post_liability_loan_hire_response['data']['business_id']
    get_action_data = get_business_data_with_action_id(business_id, customer_id)
    get_action_response = get_action_data.json()
    common.check_reponse_message(get_action_response, constants.get_business_case_id_success_message)
    assert get_action_response["isError"] is False
    ...
    logger.info("Fetch Loan Hire Action Data With Business Id Test Passed!")


@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_life_assurance_action_data_with_business_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_policy_data, post_business_data,
                                                           get_business_data_with_action_id):
    ...
    business_id = post_policy_life_assurance_response['data']['business_id']
    get_action_data = get_business_data_with_action_id(business_id, customer_id)
    get_action_response = get_action_data.json()
    common.check_reponse_message(get_action_response, constants.get_business_case_id_success_message)
    assert get_action_response["isError"] is False
    ...
    logger.info("Fetch Life Assurance Action Data With Business Id Test Passed!")


@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_pensions_action_data_with_business_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_policy_data, post_business_data,
                                                     get_business_data_with_action_id):
    ...
    business_id = post_policy_pensions_response['data']['business_id']
    get_action_data = get_business_data_with_action_id(business_id, customer_id)
    get_action_response = get_action_data.json()
    common.check_reponse_message(get_action_response, constants.get_business_case_id_success_message)
    assert get_action_response["isError"] is False
    ...
    logger.info("Fetch Pensions Action Data With Business Id Test Passed!")


@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_investment_action_data_with_business_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_policy_data, post_business_data,
                                                       get_business_data_with_action_id):
    ...
    common.compare_dicts(post_policy_pensions_response['data'], get_action_response['data'])
    logger.info("Fetch Investment Action Data With Business Id Test Passed!")


@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_general_action_data_with_business_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_policy_data,
                                                    post_business_data, get_business_data_with_action_id):
    ...
    business_id = post_policy_general_response['data']['business_id']
    get_action_data = get_business_data_with_action_id(business_id, customer_id)
    get_action_response = get_action_data.json()
    common.check_reponse_message(get_action_response, constants.get_business_case_id_success_message)
    assert get_action_response["isError"] is False
    logger.info("Action Details For General Fetched Successfully")

    common.compare_dicts(post_policy_general_response['data'], get_action_response['data'])
    logger.info("Fetch General Action Data With Business Id Test Passed!")



@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_policies_savings_plans_actions_with_business_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_policy_data,
                                                    post_business_data, get_business_data_with_action_id):
    ...
    common.check_reponse_message(get_action_response, constants.get_business_case_id_success_message)
    assert get_action_response["isError"] is False
    logger.info("Action Details For Savings Fetched Successfully")

    common.compare_dicts(post_policy_general_response['data'], get_action_response['data'])
    logger.info("Fetch Savings Action Data With Business Id Test Passed!")


@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_policies_income_protection_actions_data_with_business_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_policy_data,
                                                    post_business_data, get_business_data_with_action_id):
    ...
    common.compare_dicts(post_policy_general_response['data'], get_action_response['data'])
    logger.info("Fetch Income Protection Action Data With Business Id Test Passed!")


@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_policies_health_assurance_actions_with_business_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_policy_data,
                                                    post_business_data, get_business_data_with_action_id):
    ...
    common.compare_dicts(post_policy_general_response['data'], get_action_response['data'])
    logger.info("Fetch Health Assurance Action Data With Business Id Test Passed!")


@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_business_action_with_invalid_business_id(customer_id,data, create_client, get_business_data_with_action_id):

    get_action_data = get_business_data_with_action_id('d37fcd87-1881-4798-af93-802fea5027b9', customer_id)
    get_action_response = get_action_data.json()
    common.check_reponse_message(get_action_response, constants.invalid_case_id_message)
    assert get_action_response["isError"] is False
    logger.info("Fetch Action Data With Invalid Business ID Test Passed!")