...
def test_update_data_asset_investment_actions(customer_id,partner_cust_id,provider_correspondence_id,get_business_data_with_case_id,data,post_system_manager_data, dataa, field_values, create_client, post_asset_data,
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Business/test_data_business.csv"))
def test_update_data_liabilities_mortgages_actions(customer_id,partner_cust_id,provider_correspondence_id,get_business_data_with_case_id,data,post_system_manager_data, dataa, field_values, create_client, post_liability_data,
                                                   post_business_data, patch_business_data):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Business/test_data_business.csv"))
def test_update_data_liabilities_loan_hire_purchase_actions(customer_id,partner_cust_id,provider_correspondence_id,get_business_data_with_case_id,data,post_system_manager_data, dataa, field_values, create_client, post_liability_data,
                                                            post_business_data, patch_business_data):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Business/test_data_business.csv"))
def test_update_data_policies_life_assurance_actions(customer_id,partner_cust_id,provider_correspondence_id,get_business_data_with_case_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data,
                                                     post_business_data, patch_business_data):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Business/test_data_business.csv"))
def test_update_data_policies_pensions_actions(customer_id,partner_cust_id,provider_correspondence_id,get_business_data_with_case_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data,
                                               post_business_data, patch_business_data):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Business/test_data_business.csv"))
def test_update_data_policies_investments_actions(customer_id,partner_cust_id,provider_correspondence_id,get_business_data_with_case_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data,
                                                  post_business_data, patch_business_data):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Business/test_data_business.csv"))
def test_update_data_policies_savings_plans_actions(customer_id,partner_cust_id,provider_correspondence_id,get_business_data_with_case_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data,
                                                    post_business_data, patch_business_data):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Business/test_data_business.csv"))
def test_update_data_policies_income_protection_actions(customer_id,partner_cust_id,provider_correspondence_id,get_business_data_with_case_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data,
                                                        post_business_data, patch_business_data):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Business/test_data_business.csv"))
def test_update_data_policies_health_assurance_actions(customer_id,partner_cust_id,provider_correspondence_id,get_business_data_with_case_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data,
                                                       post_business_data, patch_business_data):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Business/test_data_business.csv"))
def test_update_data_policies_general_actions(customer_id,partner_cust_id,provider_correspondence_id,get_business_data_with_case_id,data,post_system_manager_data,dataa, field_values, create_client, post_policy_data,
                                              post_business_data, patch_business_data):
