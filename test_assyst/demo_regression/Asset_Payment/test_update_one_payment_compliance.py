...
def test_update_asset_investment_payment_complaince(customer_id,partner_cust_id,provider_correspondence_id,get_payment_data_with_case_id,post_system_manager_data,dataa,data, field_values, create_client, post_asset_data,
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_payment_complaince.csv"))
def test_update_asset_share_holdings_payment_complaince(customer_id,partner_cust_id,provider_correspondence_id,get_payment_data_with_case_id,post_system_manager_data,dataa,data, field_values, create_client, post_asset_data,
                                                    post_asset_payment_data, patch_asset_payment_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_payment_complaince.csv"))
def test_update_asset_banks_building_societies_payment_complaince(customer_id,partner_cust_id,provider_correspondence_id,get_payment_data_with_case_id,post_system_manager_data,dataa,data, field_values, create_client, post_asset_data,
                                                    post_asset_payment_data, patch_asset_payment_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_payment_complaince.csv"))
def test_update_liabilities_mortgages_payment_complaince(customer_id,partner_cust_id,provider_correspondence_id,get_payment_data_with_case_id,post_system_manager_data,dataa,data, field_values, create_client, post_liability_data,
                                                    post_asset_payment_data, patch_asset_payment_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_payment_complaince.csv"))
def test_update_liabilities_loan_hire_purchase_payment_complaince(customer_id,partner_cust_id,provider_correspondence_id,get_payment_data_with_case_id,post_system_manager_data,dataa,data, field_values, create_client, post_liability_data,
                                                    post_asset_payment_data, patch_asset_payment_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_payment_complaince.csv"))
def test_update_Credit_cards_payment_complaince(customer_id,partner_cust_id,provider_correspondence_id,get_payment_data_with_case_id,post_system_manager_data,dataa,data, field_values, create_client, post_liability_data,
                                                    post_asset_payment_data, patch_asset_payment_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_payment_complaince.csv"))
def test_update_policies_life_assurance_complaince(customer_id,partner_cust_id,provider_correspondence_id,get_payment_data_with_case_id,post_system_manager_data,dataa,data, field_values, create_client, post_policy_data,
                                                    post_asset_payment_data, patch_asset_payment_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_payment_complaince.csv"))
def test_update_policies_pensions_complaince(customer_id,partner_cust_id,provider_correspondence_id,get_payment_data_with_case_id,post_system_manager_data,dataa,data, field_values, create_client, post_policy_data,
                                                    post_asset_payment_data, patch_asset_payment_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_payment_complaince.csv"))
def test_update_policies_investments_complaince(customer_id,partner_cust_id,provider_correspondence_id,get_payment_data_with_case_id,post_system_manager_data,dataa,data, field_values, create_client, post_policy_data,
                                                    post_asset_payment_data, patch_asset_payment_data):
    # Create Client
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_payment_complaince.csv"))
def test_update_policies_savings_plans_complaince(customer_id,partner_cust_id,provider_correspondence_id,get_payment_data_with_case_id,post_system_manager_data,dataa,data, field_values, create_client, post_policy_data,
                                                    post_asset_payment_data, patch_asset_payment_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_payment_complaince.csv"))
def test_update_policies_income_protection_complaince(customer_id,partner_cust_id,provider_correspondence_id,get_payment_data_with_case_id,post_system_manager_data,dataa,data, field_values, create_client, post_policy_data,
                                                    post_asset_payment_data, patch_asset_payment_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_payment_complaince.csv"))
def test_update_policies_health_assurance_complaince(customer_id,partner_cust_id,provider_correspondence_id,get_payment_data_with_case_id,post_system_manager_data,dataa,data, field_values, create_client, post_policy_data,
                                                    post_asset_payment_data, patch_asset_payment_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_payment_complaince.csv"))
def test_update_policies_general_payments_complaince(customer_id,partner_cust_id,provider_correspondence_id,get_payment_data_with_case_id,post_system_manager_data,dataa,data, field_values, create_client, post_policy_data,
                                                    post_asset_payment_data, patch_asset_payment_data):
