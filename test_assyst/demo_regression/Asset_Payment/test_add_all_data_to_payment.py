...
def test_add_all_data_to_asset_investment_payment(partner_cust_id,customer_id,provider_correspondence_id,data, field_values, create_client, post_asset_data,
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_asset_payment.csv"))
def test_add_all_data_to_asset_share_holdings_payment(partner_cust_id,customer_id,provider_correspondence_id,data, field_values, create_client, post_asset_data,
                                                      post_asset_payment_data, post_system_manager_data, dataa):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_asset_payment.csv"))
def test_add_all_data_to_asset_banks_building_societies_payment(partner_cust_id,customer_id,provider_correspondence_id,data, field_values, create_client, post_asset_data,
                                                                post_asset_payment_data, post_system_manager_data, dataa):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_asset_payment.csv"))
def test_add_all_data_to_liabilities_mortgages_payment(partner_cust_id,post_liability_data,customer_id,provider_correspondence_id,data, field_values, create_client,
                                                       post_asset_payment_data, post_system_manager_data, dataa):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_asset_payment.csv"))
def test_add_all_data_to_liabilities_loan_hire_purchase_payments(post_liability_data,partner_cust_id,customer_id,provider_correspondence_id,data, field_values, create_client,post_system_manager_data, dataa,
                                                                 post_asset_payment_data):


    post_asset = post_liability_data(customer_id, partner_cust_id, provider_correspondence_id, None, 'liabilities_loan_hire_purchase_liability', True)
    post_loan_hire_response = post_asset.json()
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_asset_payment.csv"))
def test_add_all_data_to_liabilities_credit_cards_payments(partner_cust_id,customer_id,provider_correspondence_id,data, field_values, create_client, post_liability_data,
                                                           post_asset_payment_data, post_system_manager_data, dataa):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_asset_payment.csv"))
def test_add_all_data_to_policies_life_assurance_payment(partner_cust_id,customer_id,provider_correspondence_id,data, field_values,post_system_manager_data, dataa, create_client, post_policy_data,
                                                         post_asset_payment_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_asset_payment.csv"))
def test_add_all_data_to_policies_pensions_payment(partner_cust_id,customer_id,provider_correspondence_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data,
                                                   post_asset_payment_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_asset_payment.csv"))
def test_add_all_data_to_policies_investments_payments(partner_cust_id,customer_id,provider_correspondence_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data,
                                                       post_asset_payment_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_asset_payment.csv"))
def test_add_all_data_to_policies_savings_plans_payment(partner_cust_id,customer_id,provider_correspondence_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data,
                                                        post_asset_payment_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_asset_payment.csv"))
def test_add_all_data_to_policies_income_protection_payment(partner_cust_id,customer_id,provider_correspondence_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data,
                                                            post_asset_payment_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_asset_payment.csv"))
def test_add_all_data_to_policies_health_assurance_payment(partner_cust_id,customer_id,provider_correspondence_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data,
                                                           post_asset_payment_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Payment/"
                                                         "test_data_asset_payment.csv"))
def test_add_all_data_to_policies_general_payment(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data,
                                                  post_asset_payment_data):
