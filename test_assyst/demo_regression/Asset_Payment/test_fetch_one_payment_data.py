...
def test_fetch_payment_data_with_valid_case_id(partner_cust_id,customer_id,provider_correspondence_id,data, create_client, post_asset_data,post_system_manager_data, dataa,
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_asset_share_holdings_asset_case_id(partner_cust_id,customer_id,provider_correspondence_id,data, create_client, post_asset_data,post_system_manager_data, dataa,
                                               post_asset_payment_data, get_payment_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_asset_banks_building_societies_paymentcase_id(partner_cust_id,customer_id,provider_correspondence_id,data, post_system_manager_data, dataa, create_client, post_asset_data,
                                               post_asset_payment_data, get_payment_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_liabilities_mortgages_payment_case_id(partner_cust_id,customer_id,provider_correspondence_id,data, create_client, post_liability_data,post_system_manager_data, dataa,
                                               post_asset_payment_data, get_payment_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_liabilities_loan_hire_purchase_payments_case_id(partner_cust_id,customer_id,provider_correspondence_id,data, post_system_manager_data, dataa, create_client, post_liability_data,
                                               post_asset_payment_data, get_payment_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_liabilities_credit_cards_payments_case_id(partner_cust_id,customer_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_liability_data,
                                               post_asset_payment_data, get_payment_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_policies_life_assurance_payment_case_id(partner_cust_id,customer_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_policy_data,
                                               post_asset_payment_data, get_payment_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_policies_pensions_payment_case_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data,dataa, create_client, post_policy_data,
                                               post_asset_payment_data, get_payment_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_policies_investments_payments_case_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_policy_data,
                                               post_asset_payment_data, get_payment_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_policies_savings_plans_payment_case_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_policy_data,
                                               post_asset_payment_data, get_payment_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_policies_income_protection_payment_case_id(partner_cust_id,customer_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_policy_data,
                                               post_asset_payment_data, get_payment_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_policies_health_assurance_payment_case_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_policy_data,
                                               post_asset_payment_data, get_payment_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_policies_general_payment_case_id(customer_id,partner_cust_id,provider_correspondence_id,data, create_client,post_system_manager_data, dataa, post_policy_data,
                                               post_asset_payment_data, get_payment_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_asset_data_with_invalid_asset_id(customer_id,data, create_client, get_payment_data_with_case_id):
