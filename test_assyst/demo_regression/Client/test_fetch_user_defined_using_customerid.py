...
def test_fetch_data_to_user_defined(customer_id,get_userdefined_value_data_with_customer_id, post_system_manager_data,create_client,data,dataa,post_userdefined_value):
