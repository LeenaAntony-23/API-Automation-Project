...
def test_add_all_data_to_employment(customer_id,data, field_values, create_client, post_client_data,
...
def test_add_all_data_to_identity(customer_id,data, field_values, create_client, post_client_data,
                                     get_client_data_with_customer_id):
...
def test_add_all_data_to_objectives(customer_id,data, field_values, create_client, post_client_data,
                                     get_client_data_with_customer_id):
...
def test_add_all_data_to_servicetype(customer_id,data, field_values, create_client, post_client_data,
                                     get_client_data_with_customer_id):
...
def test_add_all_data_to_vulnerability(customer_id,data, field_values, create_client, post_vulnerability_data,
