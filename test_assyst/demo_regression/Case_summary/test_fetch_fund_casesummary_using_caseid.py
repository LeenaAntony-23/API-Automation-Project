...
def test_fetch_asset_investment_fund_casesummary_data_with_valid_asset_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_asset_data, post_fund_data, get_fund_casesummary_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_policy_life_assurance_fund_casesummary_data_with_valid_asset_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data,dataa, create_client, post_policy_data,  post_fund_data, get_fund_casesummary_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_policy_pensions_fund_casesummary_data_with_valid_asset_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_policy_data,  post_fund_data, get_fund_casesummary_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_policy_investments_fund_casesummary_data_with_valid_asset_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_policy_data,  post_fund_data, get_fund_casesummary_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_policy_savings_plans_fund_casesummary_data_with_valid_asset_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_policy_data,  post_fund_data, get_fund_casesummary_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_policy_income_protection_fund_casesummary_data_with_valid_asset_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_policy_data,  post_fund_data, get_fund_casesummary_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_policy_health_assurance_fund_casesummary_data_with_valid_asset_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_policy_data,  post_fund_data, get_fund_casesummary_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_policy_general_fund_casesummary_data_with_valid_asset_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_policy_data,  post_fund_data, get_fund_casesummary_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_fund_casesummary_data_with_invalid_case_id(customer_id,data, create_client, get_fund_casesummary_data_with_case_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_fund_casesummary_data_with_invalid_customer_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_fund_data,post_policy_data, post_system_manager_data, dataa,create_client, get_fund_casesummary_data_with_case_id):
