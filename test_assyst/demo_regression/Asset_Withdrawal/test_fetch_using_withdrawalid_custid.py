...
def test_update_asset_investment_withdrawal(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_asset_data, post_asset_withdrawal_data,get_withdrawal_data_with_withdrawal_id):
    # Create Client
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_update_asset_sharehold_withdrawal(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_asset_data, post_asset_withdrawal_data,get_withdrawal_data_with_withdrawal_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_update_asset_bank_withdrawal(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_asset_data, post_asset_withdrawal_data,get_withdrawal_data_with_withdrawal_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_update_policy_life_assurance_withdrawal(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_asset_withdrawal_data,post_policy_data ,get_withdrawal_data_with_withdrawal_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_update_pension_withdrawal(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_asset_withdrawal_data,post_policy_data ,get_withdrawal_data_with_withdrawal_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_update_policies_investments_withdrawals(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data,dataa, create_client, post_asset_withdrawal_data,post_policy_data ,get_withdrawal_data_with_withdrawal_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_update_policies_savings_plans_withdrawals(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_asset_withdrawal_data,post_policy_data ,get_withdrawal_data_with_withdrawal_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_update_policies_income_protection_withdrawal(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_asset_withdrawal_data,post_policy_data ,get_withdrawal_data_with_withdrawal_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_update_policies_health_assurance_withdrawals(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_asset_withdrawal_data,post_policy_data ,get_withdrawal_data_with_withdrawal_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_update_policies_general_withdrawals(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_asset_withdrawal_data, post_policy_data,
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_withdrawal_data_with_invalid_withdrawal_id(customer_id,data, create_client, get_withdrawal_data_with_withdrawal_id):
