...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Withdrawal/test_data_asset_withdrawals.csv"))
def test_update_asset_investment_withdrawal(customer_id,partner_cust_id,provider_correspondence_id,get_withdrawal_data_with_withdrawal_id,data,post_system_manager_data, dataa, field_values, create_client, post_asset_data,
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Withdrawal/test_data_asset_withdrawals.csv"))
def test_update_asset_share_holdings_withdrawals(customer_id,partner_cust_id,provider_correspondence_id,get_withdrawal_data_with_withdrawal_id,data,post_system_manager_data, dataa,  field_values, create_client, post_asset_data,
                                                    post_asset_withdrawal_data, patch_withdrawal_data ):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Withdrawal/test_data_asset_withdrawals.csv"))
def test_update_asset_banks_building_societies_withdrawals(customer_id,partner_cust_id,provider_correspondence_id,get_withdrawal_data_with_withdrawal_id,data,post_system_manager_data, dataa, field_values, create_client, post_asset_data,
                                                    post_asset_withdrawal_data,patch_withdrawal_data ):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Withdrawal/test_data_asset_withdrawals.csv"))
def test_update_life_assurance_policy(customer_id,partner_cust_id,provider_correspondence_id,get_withdrawal_data_with_withdrawal_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data, post_asset_withdrawal_data,patch_withdrawal_data):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Withdrawal/test_data_asset_withdrawals.csv"))
def test_update_pension_withdrawal_policy(customer_id,partner_cust_id,provider_correspondence_id,get_withdrawal_data_with_withdrawal_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data, post_asset_withdrawal_data,patch_withdrawal_data):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Withdrawal/test_data_asset_withdrawals.csv"))
def test_update_investment_withdrawal_policy(customer_id,partner_cust_id,provider_correspondence_id,get_withdrawal_data_with_withdrawal_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data, post_asset_withdrawal_data,patch_withdrawal_data):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Withdrawal/test_data_asset_withdrawals.csv"))
def test_update_savings_withdrawal_policy(customer_id,partner_cust_id,provider_correspondence_id,get_withdrawal_data_with_withdrawal_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data, post_asset_withdrawal_data,patch_withdrawal_data):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Withdrawal/test_data_asset_withdrawals.csv"))
def test_update_health_withdrawal_policy(customer_id,partner_cust_id,provider_correspondence_id,get_withdrawal_data_with_withdrawal_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data, post_asset_withdrawal_data,patch_withdrawal_data):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Withdrawal/test_data_asset_withdrawals.csv"))
def test_update_income_withdrawal_policy(customer_id,partner_cust_id,provider_correspondence_id,get_withdrawal_data_with_withdrawal_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data, post_asset_withdrawal_data,patch_withdrawal_data):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Asset_Withdrawal/test_data_asset_withdrawals.csv"))
def test_update_general_withdrawal_policy(customer_id,partner_cust_id,provider_correspondence_id,get_withdrawal_data_with_withdrawal_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data, post_asset_withdrawal_data,patch_withdrawal_data):
