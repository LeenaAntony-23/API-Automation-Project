...
def test_fetch_policies_general_valuations_data_with_customer_id(partner_cust_id,customer_id,provider_correspondence_id,post_system_manager_data,dataa,data, create_client, post_policy_data, post_valuation_data ,get_valuation_data_with_customer_id ):
