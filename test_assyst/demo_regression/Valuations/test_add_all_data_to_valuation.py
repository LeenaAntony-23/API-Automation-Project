...
def test_add_all_data_to_asset_investment_valuations(partner_cust_id,customer_id,provider_correspondence_id,data,post_system_manager_data, dataa, field_values, create_client, post_asset_data,post_valuation_data ):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/valuations/test_data_valuations.csv"))
def test_add_all_data_to_asset_share_valuations(partner_cust_id,customer_id,provider_correspondence_id,data,post_system_manager_data, dataa, field_values, create_client, post_asset_data,post_valuation_data ):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/valuations/test_data_valuations.csv"))
def test_add_all_data_to_asset_home_valuations(partner_cust_id,customer_id,provider_correspondence_id,data,post_system_manager_data, dataa, field_values, create_client, post_asset_data,post_valuation_data ):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/valuations/test_data_valuations.csv"))
def test_add_all_data_to_asset_buildings_valuations(partner_cust_id,customer_id,provider_correspondence_id,data,post_system_manager_data, dataa, field_values, create_client, post_asset_data,post_valuation_data ):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/valuations/test_data_valuations.csv"))
def test_add_all_data_to_policy_valuations(partner_cust_id,customer_id,provider_correspondence_id,post_system_manager_data,dataa,data, field_values, create_client, post_policy_data,post_valuation_data ):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/valuations/test_data_valuations.csv"))
def test_add_all_data_to_policy_pension_valuations(partner_cust_id,customer_id,provider_correspondence_id,post_system_manager_data,dataa,data, field_values, create_client, post_policy_data,post_valuation_data ):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/valuations/test_data_valuations.csv"))
def test_add_all_data_to_policy_invest_valuations(customer_id,partner_cust_id,provider_correspondence_id,post_system_manager_data,dataa,data, field_values, create_client, post_policy_data,post_valuation_data ):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/valuations/test_data_valuations.csv"))
def test_add_all_data_to_policy_income_valuations(partner_cust_id,customer_id,provider_correspondence_id,post_system_manager_data,dataa,data, field_values, create_client, post_policy_data,post_valuation_data ):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/valuations/test_data_valuations.csv"))
def test_add_all_data_to_policy_health_valuations(partner_cust_id,customer_id,provider_correspondence_id,post_system_manager_data,dataa,data, field_values, create_client, post_policy_data,post_valuation_data ):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/valuations/test_data_valuations.csv"))
def test_add_all_data_to_policy_general_valuations(partner_cust_id,customer_id,provider_correspondence_id,post_system_manager_data,dataa,data, field_values, create_client, post_policy_data, post_valuation_data):
