...
def test_create_and_fetch_addressbook_data(customer_id,data, create_client, post_addressbook_data,
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_create_and_fetch_addressbook_data_with_invalid_id(customer_id,data, create_client, get_addressbook_data_with_address_id):
