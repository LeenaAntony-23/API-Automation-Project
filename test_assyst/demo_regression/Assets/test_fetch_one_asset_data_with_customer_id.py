...
def test_fetch_one_customer_data_with_valid_customer_id(customer_id,partner_cust_id,provider_correspondence_id,data,post_system_manager_data, dataa, create_client, post_asset_data,
                                                        get_asset_data_with_customer_id):
    ...
    logger.info("Fetch Asset Data Of One Customer Test Passed!")


def test_fetch_asset_data_with_invalid_customer_id(get_asset_data_with_customer_id):
    get_asset_data = get_asset_data_with_customer_id('ffd0c1d4-2cf4-40e7-bf87-79dc9bf608e0')
    get_asset_response = get_asset_data.json()
    common.check_reponse_message(get_asset_response, constants.invalid_customer_id_message)
