...
def test_add_load_standard_asset_Investment_case_action( customer_id,partner_cust_id,provider_correspondence_id,post_system_manager_data, data, data_sys, create_client, post_asset_data,
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("data_sys", ["./jsons/create_new_systemmanager.json"])
def test_add_load_standard_liabilities_mortgages_case_action( customer_id,partner_cust_id,provider_correspondence_id,post_system_manager_data, data, data_sys, create_client, post_liability_data,
                                     post_default_load_standard_case_action ):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("data_sys", ["./jsons/create_new_systemmanager.json"])
def test_add_load_standard_liabilities_loan_hire_purchase_case_action( customer_id,partner_cust_id,provider_correspondence_id,post_system_manager_data, data, data_sys, create_client, post_liability_data,
                                     post_default_load_standard_case_action ):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("data_sys", ["./jsons/create_new_systemmanager.json"])
def test_add_load_standard_policies_life_assurance_case_action( customer_id,partner_cust_id,provider_correspondence_id,post_system_manager_data, data, data_sys, create_client, post_policy_data,
                                     post_default_load_standard_case_action ):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("data_sys", ["./jsons/create_new_systemmanager.json"])
def test_add_load_standard_policies_pensions_case_action( customer_id,partner_cust_id,provider_correspondence_id,post_system_manager_data, data, data_sys, create_client, post_policy_data,
                                     post_default_load_standard_case_action ):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("data_sys", ["./jsons/create_new_systemmanager.json"])
def test_add_load_standard_policies_investments_case_action( customer_id,partner_cust_id,provider_correspondence_id,post_system_manager_data, data, data_sys, create_client, post_policy_data,
                                     post_default_load_standard_case_action ):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("data_sys", ["./jsons/create_new_systemmanager.json"])
def test_add_load_standard_policies_savings_plans_case_action( customer_id,partner_cust_id,provider_correspondence_id,post_system_manager_data, data, data_sys, create_client, post_policy_data,
                                     post_default_load_standard_case_action ):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("data_sys", ["./jsons/create_new_systemmanager.json"])
def test_add_load_standard_policies_income_protection_case_action( customer_id,partner_cust_id,provider_correspondence_id,post_system_manager_data, data, data_sys, create_client, post_policy_data,
                                     post_default_load_standard_case_action ):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("data_sys", ["./jsons/create_new_systemmanager.json"])
def test_add_load_standard_policies_health_assurance_case_action( customer_id,partner_cust_id,provider_correspondence_id,post_system_manager_data, data, data_sys, create_client, post_policy_data,
                                     post_default_load_standard_case_action ):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("data_sys", ["./jsons/create_new_systemmanager.json"])
def test_add_load_standard_policies_general_case_action( customer_id,partner_cust_id,provider_correspondence_id,post_system_manager_data, data, data_sys, create_client, post_policy_data,
                                     post_default_load_standard_case_action ):
