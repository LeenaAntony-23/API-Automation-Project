...
def test_fetch_all_attitude_category_data(get_attitude_category_details):
    ...
    common.check_reponse_message(get_attitude_category_details_response, constants.get_attitude_category_success_message)
