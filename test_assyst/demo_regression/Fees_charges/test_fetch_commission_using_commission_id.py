...
def test_fetch_one_customer_data_with_valid_customer_id(customer_id,data, create_client, post_client_data, get_commission_data_with_commission_id ):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test__fetch_one_customer_data_with_invalid_commission_id(customer_id,data, create_client, get_commission_data_with_commission_id):
