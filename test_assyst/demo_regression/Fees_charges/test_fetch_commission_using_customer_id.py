...
def test_fetch_one_customer_data_with_valid_customer_id(customer_id,data, create_client, post_client_data, get_commission_data_with_customer_id ):
...
def test_fetch_one_customer_data_with_invalid_commission_id(get_commission_data_with_customer_id):
        get_client_data = get_commission_data_with_customer_id('ad1eef7e-bdcd-4c0c-987a-34268221ff2e')
        ...
        logger.info("Fetch Commission Data With Invalid Customer ID Test Passed!")