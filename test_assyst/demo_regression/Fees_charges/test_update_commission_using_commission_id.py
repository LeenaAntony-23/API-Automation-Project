...
def test_update_commission_data(customer_id,get_commission_data_with_customer_id,data, field_values, create_client, post_client_data,patch_commission_data):
