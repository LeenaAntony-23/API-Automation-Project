...
def test_fetch_appointment_data_with_valid_customer_id(customer_id,get_appointment_data_with_customer_id,data, create_client, post_client_data,
                                                       ):
...
def test_fetch_fetch_appointment_data_with_invalid_customer_id(get_appointment_data_with_customer_id):
    get_client_data = get_appointment_data_with_customer_id('e34960f1-ce23-4985-a5df-d497193be3ab')
    ...
    # assert get_client_response['error']['code'] == '20004', \
    #     f"API call failed with StatusCode: {get_client_response['error']['code']}"
