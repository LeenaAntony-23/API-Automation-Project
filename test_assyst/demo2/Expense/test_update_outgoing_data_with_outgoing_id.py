...
def test_update_data_to_outgoing(customer_id,data, field_values, create_client, post_outgoing_data,patch_outgoing_data,get_outgoing_data_with_customer_id):
