...
def test_fetch_fact_find_note_data_with_valid_doc_id(customer_id,data, create_client, post_client_fact_note_data,get_notes_data_with_doc_id):
    ...
    logger.info("FactFind Note Details Fetched Successfully")
