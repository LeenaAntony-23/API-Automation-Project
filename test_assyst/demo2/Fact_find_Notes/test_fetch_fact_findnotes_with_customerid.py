...
def test_fetch_one_factnote_data_with_valid_customer_id(customer_id,post_client_fact_note_data,data, create_client,get_fact_find_notes_data_with_customer_id,post_fact_findnotes_outgoing_data_with_customer_id):
...
def test_fetch_one_customer_data_with_invalid_customer_id(get_fact_find_notes_data_with_customer_id):
    get_client_data = get_fact_find_notes_data_with_customer_id('0006f028-ea52-4eec-94d8-e995e1c80ffc')
    get_client_response = get_client_data.json()
    logger.info(get_client_response)
