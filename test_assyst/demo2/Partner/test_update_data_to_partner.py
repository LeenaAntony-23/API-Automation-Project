...
# @pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Partner/test_data_name_and_address.csv"))
# def test_update_partner_name_address_data(get_client_data_with_partner_customer_id,data, field_values, create_client, patch_client_data, post_partner_data):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Partner/test_data_contact.csv"))
def test_update_partner_contact_data(get_client_data_with_partner_customer_id,data, field_values, create_client, patch_client_data, post_partner_data):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Partner/test_data_nationality.csv"))
def test_update_partner_nationality_data(get_client_data_with_partner_customer_id,data, field_values, create_client, post_partner_data, patch_client_data):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Partner/test_data_personal.csv"))
def test_update_partner_personal_data(get_client_data_with_partner_customer_id,data, field_values, create_client, patch_client_data, post_partner_data):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Partner/test_data_health_note.csv"))
def test_update_partner_health_note_data(get_client_data_with_partner_customer_id,data, field_values, create_client, patch_client_data, post_partner_data):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Partner/test_data_employment.csv"))
def test_update_partner_employment_data(get_client_data_with_partner_customer_id,patch_employment_data,post_client_data,data, field_values, create_client, patch_client_data, post_partner_data):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Partner/test_data_objectives.csv"))
def test_update_partner_objective_data(get_client_data_with_partner_customer_id,patch_clientobjectives_data,post_client_data,data, field_values, create_client, patch_client_data, post_partner_data):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Partner/test_data_service_type.csv"))
def test_update_partner_servicetype_data(get_client_data_with_partner_customer_id,patch_clientservicetype_data,post_client_data,data, field_values, create_client, patch_client_data, post_partner_data):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Partner/test_data_identity.csv"))
def test_update_partner_identity_data(get_client_data_with_partner_customer_id,patch_clientidentity_data,post_client_data,data, field_values, create_client, patch_client_data, post_partner_data):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
