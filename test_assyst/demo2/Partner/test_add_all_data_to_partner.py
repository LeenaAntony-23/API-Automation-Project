...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Partner/test_data_name_and_address_partner_trail.csv"))
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Partner/test_data_vulnerability.csv"))
