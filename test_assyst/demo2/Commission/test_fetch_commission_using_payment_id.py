...
def test_fetch_all_data_of_commission_using_payment_id(customer_id,partner_cust_id, provider_correspondence_id,data,post_system_manager_data,dataa, create_client, post_asset_data, post_asset_payment_data,post_asset_commission_data,get_asset_commission_data_with_payment_id ):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_asset_share_holdings_commission_data_using_payment_id(customer_id,partner_cust_id, provider_correspondence_id,data,post_system_manager_data,dataa,get_asset_commission_data_with_payment_id, create_client, post_asset_data, post_asset_payment_data,post_asset_commission_data ):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_asset_banks_building_data_using_payment_id(customer_id, partner_cust_id,provider_correspondence_id,data,post_system_manager_data,dataa, create_client, post_asset_data, post_asset_payment_data,post_asset_commission_data,get_asset_commission_data_with_payment_id ):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_liab_mortgage_data_using_payment_id(customer_id,partner_cust_id, provider_correspondence_id,data,post_system_manager_data,dataa, create_client, post_liability_data, post_asset_payment_data,post_asset_commission_data,get_asset_commission_data_with_payment_id ):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_liab_loan_hire_using_payment_id(customer_id,partner_cust_id, provider_correspondence_id,data,post_system_manager_data,dataa, create_client, post_liability_data, post_asset_payment_data,post_asset_commission_data,get_asset_commission_data_with_payment_id ):
    post_liability = post_liability_data(customer_id, partner_cust_id,provider_correspondence_id, None,
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_all_data_from_liabilities_credit_card_data_using_payment_id(customer_id,partner_cust_id, provider_correspondence_id,data, post_system_manager_data, dataa, create_client, post_liability_data,
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_policy_pension_commission_using_payment_id(customer_id,partner_cust_id, provider_correspondence_id,data,post_system_manager_data,dataa,post_policy_data, create_client, post_asset_payment_data,post_asset_commission_data,get_asset_commission_data_with_payment_id ):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_policy_investment_commission_using_payment_id(customer_id,partner_cust_id, provider_correspondence_id,data,post_system_manager_data,dataa,post_policy_data, create_client, post_asset_payment_data,post_asset_commission_data,get_asset_commission_data_with_payment_id ):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_policy_savings_commission_using_payment_id(customer_id,partner_cust_id, provider_correspondence_id,data,post_system_manager_data,dataa,post_policy_data, create_client, post_asset_payment_data,post_asset_commission_data,get_asset_commission_data_with_payment_id ):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_policy_income_commission_using_payment_id(customer_id,partner_cust_id, provider_correspondence_id,data,post_system_manager_data,dataa,post_policy_data, create_client, post_asset_payment_data,post_asset_commission_data,get_asset_commission_data_with_payment_id ):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_policy_general_commission_using_payment_id(customer_id,partner_cust_id, provider_correspondence_id,data,post_system_manager_data,dataa,post_policy_data, create_client, post_asset_payment_data,post_asset_commission_data,get_asset_commission_data_with_payment_id ):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_policy_life_commission_using_payment_id(customer_id,partner_cust_id, provider_correspondence_id,data,post_system_manager_data,dataa,post_policy_data, create_client, post_asset_payment_data,post_asset_commission_data,get_asset_commission_data_with_payment_id ):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_all_data_of_commission_using_invalid_payment_id(customer_id, partner_cust_id,provider_correspondence_id,post_system_manager_data,dataa,data, create_client, post_asset_data, post_asset_payment_data,post_asset_commission_data,get_asset_commission_data_with_payment_id ):
