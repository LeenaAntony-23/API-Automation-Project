...
def test_add_data_to_asset_investment_payment_commission(customer_id,partner_cust_id, provider_correspondence_id,data,dataa,post_system_manager_data, field_values, create_client, post_asset_data,
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Commission/test_data_asset_payment_commission.csv"))
def test_add_data_to_asset_share_holdings_commission(customer_id,partner_cust_id, provider_correspondence_id,data, field_values, create_client, post_asset_data,
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Commission/test_data_asset_payment_commission.csv"))
def test_add_data_to_asset_banks_building_commission(customer_id,partner_cust_id, provider_correspondence_id,data, field_values, create_client, post_asset_data,post_system_manager_data, dataa,
                                                     post_asset_payment_data, post_asset_commission_data):
...
def test_add_all_data_to_liabilities_mortgages_payment_commission(customer_id,partner_cust_id, provider_correspondence_id,data, field_values, create_client, post_liability_data,post_system_manager_data, dataa,
                                                       post_asset_payment_data, post_asset_commission_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Commission/"
                                                         "test_data_asset_payment_commission.csv"))
def test_add_all_data_to_liabilities_loan_hire_payment_commission(customer_id,partner_cust_id, provider_correspondence_id,data, field_values, create_client, post_liability_data,post_system_manager_data, dataa ,
                                                       post_asset_payment_data, post_asset_commission_data):
    post_liability = post_liability_data(customer_id,partner_cust_id, provider_correspondence_id, None,
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Commission/"
                                                         "test_data_asset_payment_commission.csv"))
def test_add_all_data_to_liabilities_credit_card_payment_commission(customer_id,partner_cust_id, provider_correspondence_id,data, field_values, create_client, post_liability_data,post_system_manager_data, dataa,
                                                       post_asset_payment_data, post_asset_commission_data):
    post_liability = post_liability_data(customer_id,partner_cust_id, provider_correspondence_id, None,
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Commission/"
                                                         "test_data_asset_payment_commission.csv"))
def test_add_all_data_to_policies_life_assurance_payment_commission(customer_id,partner_cust_id, provider_correspondence_id,post_system_manager_data,dataa,data, field_values, create_client, post_policy_data,
                                                         post_asset_payment_data, post_asset_commission_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Commission/"
                                                         "test_data_asset_payment_commission.csv"))
def test_add_all_data_to_policies_pension_payment_commission(customer_id,partner_cust_id, provider_correspondence_id,post_system_manager_data,dataa,data, field_values, create_client,post_policy_data,
                                                              post_asset_payment_data, post_asset_commission_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Commission/"
                                                         "test_data_asset_payment_commission.csv"))
def test_add_all_data_to_policies_investment_payment_commission(customer_id,partner_cust_id, provider_correspondence_id,post_system_manager_data,dataa,data, field_values, create_client,post_policy_data,
                                                              post_asset_payment_data, post_asset_commission_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Commission/"
                                                         "test_data_asset_payment_commission.csv"))
def test_add_all_data_to_policies_savingsplan_payment_commission(customer_id,partner_cust_id, provider_correspondence_id,post_system_manager_data,dataa,data, field_values, create_client,post_policy_data,
                                                              post_asset_payment_data, post_asset_commission_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Commission/"
                                                         "test_data_asset_payment_commission.csv"))
def test_add_all_data_to_policies_income_payment_commission(customer_id,partner_cust_id, provider_correspondence_id,post_system_manager_data,dataa,data, field_values, create_client,post_policy_data,
                                                              post_asset_payment_data, post_asset_commission_data):
...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Commission/"
                                                         "test_data_asset_payment_commission.csv"))
def test_add_all_data_to_policies_general_payment_commission(customer_id,partner_cust_id, provider_correspondence_id,post_system_manager_data,dataa,data, field_values, create_client,post_policy_data,
                                                              post_asset_payment_data, post_asset_commission_data):
