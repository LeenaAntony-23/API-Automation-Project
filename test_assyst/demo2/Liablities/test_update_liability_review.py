...
def test_update_data_to_liabilities_mortgages_liability_review(partner_cust_id,customer_id,provider_correspondence_id,post_system_manager_data,dataa,data, field_values, create_client, post_liability_data,patch_liability_review_data):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Liability/test_data_liability_review.csv"))
def test_update_data_to_liabilities_loan_hire_purchase_liability_review(partner_cust_id,customer_id,provider_correspondence_id,post_system_manager_data,dataa,data, field_values, create_client, post_liability_data,patch_liability_review_data):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Liability/test_data_liability_review.csv"))
def test_update_data_to_liabilities_credit_cards_liability_review(partner_cust_id,customer_id,provider_correspondence_id,post_system_manager_data,dataa,data, field_values, create_client, post_liability_data,patch_liability_review_data):
