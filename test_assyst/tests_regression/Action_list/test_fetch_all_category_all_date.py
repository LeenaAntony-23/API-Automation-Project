...
def test_fetch_actionlist_all_category_all_date(get_actionlist_with_user_id):

    # for calling get function
    get_action_data = get_actionlist_with_user_id("0a17faea-e881-414b-9c3c-69b92ec1f881")  #actionlistapi
