...
def test_fetch_asset_listing(post_partner_data,dataa,post_asset_listing,post_fund_data,post_system_manager_data,create_client, post_asset_data, data, post_client_data,post_policy_data):
...
#post_asset_listing
    post_asset_listing_info = post_asset_listing(customer_id,jointindicator,partner_cust_id)

    logger.info(post_asset_listing_info)
    logger.info("All Details Fetched Successfully")
#
# @pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
# def test_fetch_asset_listing_multitenant_testing(dataa, post_asset_listing, post_system_manager_data,
#                                      post_asset_data):
#     customer_id = "19a3b122-3f00-4236-b2fe-90a47b9b6c33"
#     # post provider
#
#
#     post_asset_listing_info = post_asset_listing(customer_id)
#
#     logger.info(post_asset_listing_info)
