...
def test_add_policy_payment_withdrawal(post_partner_data,post_asset_payment_data,post_asset_withdrawal_data,post_policy_payment_withdrawal,dataa,post_policy_schedule,post_asset_listing,post_fund_data,post_system_manager_data,create_client, post_asset_data, data, post_client_data,post_policy_data):
    ...
    if policyholder == 0:
        ...
        customer_id = partner_cust_id
    post_policy_withdrawal = post_asset_withdrawal_data(customer_id,partner_cust_id, policy_id, None,
                                                        'policies_life_assurance_withdrawals', True)
    ...
    if policyholder == 0:
        ...
        customer_id = partner_cust_id
    post_policy_withdrawal = post_asset_withdrawal_data(customer_id, policy_id, None, 'policies_pensions_withdrawals',
                                                        True)
    post_policy_withdrawal_response = post_policy_withdrawal.json()
    common.check_reponse_message(post_policy_withdrawal_response, constants.add_asset_withdrawal_success_message)
    logger.info("Withdrawal Details   Added Successfully")
    ...
    if policyholder == 0:
        ...
        customer_id = partner_cust_id
    post_policy_withdrawal = post_asset_withdrawal_data(customer_id, policy_id, None,
                                                        'policies_investments_withdrawals', True)
    post_policy_withdrawal_response = post_policy_withdrawal.json()
    common.check_reponse_message(post_policy_withdrawal_response, constants.add_asset_withdrawal_success_message)
    logger.info("Withdrawal Details   Added Successfully")
    ...
    if policyholder == 0:
        ...
        customer_id = partner_cust_id
    post_policy_withdrawal = post_asset_withdrawal_data(customer_id, policy_id, None,
                                                        'policies_savings_plans_withdrawals', True)
    post_policy_withdrawal_response = post_policy_withdrawal.json()
    common.check_reponse_message(post_policy_withdrawal_response, constants.add_asset_withdrawal_success_message)
    logger.info("Withdrawal Details   Added Successfully")
    #
    ...
    if policyholder == 0:
        ...
        customer_id = partner_cust_id
    post_policy_withdrawal = post_asset_withdrawal_data(customer_id, policy_id, None,
                                                        'policies_income_protection_withdrawals', True)
    post_policy_withdrawal_response = post_policy_withdrawal.json()
    common.check_reponse_message(post_policy_withdrawal_response, constants.add_asset_withdrawal_success_message)
    logger.info("Withdrawal Details   Added Successfully")
    #
    ...
    if policyholder == 0:
        ...
        customer_id = partner_cust_id
    post_policy_withdrawal = post_asset_withdrawal_data(customer_id, policy_id, None,
                                                        'policies_health_assurance_withdrawals', True)
    post_policy_withdrawal_response = post_policy_withdrawal.json()
    common.check_reponse_message(post_policy_withdrawal_response, constants.add_asset_withdrawal_success_message)
    logger.info("Withdrawal Details   Added Successfully")
    #
    ...
    if policyholder == 0:
        ...
        customer_id = partner_cust_id
    post_policy_withdrawal = post_asset_withdrawal_data(customer_id, policy_id, None, 'policies_general_withdrawals',
                                                        True)
    post_policy_withdrawal_response = post_policy_withdrawal.json()
    common.check_reponse_message(post_policy_withdrawal_response, constants.add_asset_withdrawal_success_message)
    logger.info("Withdrawal Details   Added Successfully")

    # post_policy_payment_withdrawal
    post_policy_payment_withdrawal_info = post_policy_payment_withdrawal(customer_id,policyholder,partner_cust_id)
    logger.info(post_policy_payment_withdrawal_info)
    logger.info("All Details Fetched Successfully")

# @pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
# def test_add_policy_payment_withdrawal_multitenanttesting(post_policy_data,dataa,post_policy_payment_withdrawal,post_system_manager_data, post_asset_data):
#
#     customer_id = "19a3b122-3f00-4236-b2fe-90a47b9b6c33"
#
#
#     # post_asset_listing
#     post_asset_listing_info = post_policy_payment_withdrawal(customer_id)
