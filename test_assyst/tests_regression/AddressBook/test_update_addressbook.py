...
def test_create_and_fetch_addressbook_data(data,get_addressbook_data_with_customer_id,  field_values, create_client, post_addressbook_data, patch_addressbook_data):
