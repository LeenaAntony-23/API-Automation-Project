...
def test_update_user_defined_valid_customer_id(get_client_data_with_customer_id,post_system_manager_data,create_client,data,dataa,post_userdefined_value, patch_user_defined_value_data):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_update_user_defined_invalid_customer_id(post_system_manager_data,create_client,data,dataa,post_userdefined_value, patch_user_defined_value_data):
    # system manager user defined post
    post_user = post_system_manager_data(dataa, 'user_defined_field', True)
    post_user_response = post_user.json()
    logger.info(post_user_response)
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_update_user_defined_invalid_user_defined_value_id(post_system_manager_data,create_client,data,dataa,post_userdefined_value, patch_user_defined_value_data):
    # system manager user defined post
    post_user = post_system_manager_data(dataa, 'user_defined_field', True)
    post_user_response = post_user.json()
    logger.info(post_user_response)
