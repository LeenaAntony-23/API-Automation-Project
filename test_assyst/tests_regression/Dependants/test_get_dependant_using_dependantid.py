...
def test_fetch_dependant_data_with_valid_customer_id(data, create_client, post_dependant_data,get_dependant_data_with_dependant_id):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_dependant_data_with_invalidvalid_dependent_id(data, create_client, post_dependant_data,get_dependant_data_with_dependant_id):
