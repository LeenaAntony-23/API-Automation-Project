...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/Liability/test_data_mortgages_liability.csv"))
def test_update_data_to_liabilities_mortgages_liability(post_partner_data,get_liability_data_with_customer_id,post_system_manager_data,dataa,data, field_values, create_client, post_liability_data,patch_liability_data):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/Liability/test_data_loan_hire_purchase_liability.csv"))
def test_update_data_to_loan_hire_purchase(post_partner_data,get_liability_data_with_customer_id,post_system_manager_data,dataa,data, field_values, create_client, post_liability_data,patch_liability_data):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/Liability/test_data_credit_cards_liability.csv"))
def test_update_data_to_credit_cards_liability(post_partner_data,get_liability_data_with_customer_id,post_system_manager_data,dataa,data, field_values, create_client, post_liability_data,patch_liability_data):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
