...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/Client/test_data_fees_charges.csv"))
def test_update_commission_data(data, field_values, create_client, post_client_data,patch_commission_data):
