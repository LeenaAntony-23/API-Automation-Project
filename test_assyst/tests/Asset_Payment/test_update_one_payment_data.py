...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/Asset_Payment/test_data_asset_payment.csv"))
def test_update_asset_investment_payment(post_partner_data,get_payment_data_with_case_id,data, field_values,post_system_manager_data, dataa, create_client, post_asset_data,
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/Asset_Payment/test_data_asset_payment.csv"))
def test_update_asset_share_holdings_payment(post_partner_data,get_payment_data_with_case_id,data, post_system_manager_data, dataa, field_values, create_client, post_asset_data,post_asset_payment_data, patch_asset_payment_data):
    # Create Client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/Asset_Payment/test_data_asset_payment.csv"))
def test_update_asset_banks_building_societies(post_partner_data,get_payment_data_with_case_id,data, field_values, create_client, post_asset_data,post_system_manager_data, dataa,
                                                          post_asset_payment_data, patch_asset_payment_data):
    # Create Client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    ...
    # # Create banks and building asset
    customer_id = create_client_response['data']['customer_id']
    partner_data = post_partner_data(customer_id, None, "name_and_address", True)
    partner_data_response = partner_data.json()
    logger.info(partner_data_response)
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/Asset_Payment/test_data_asset_payment.csv"))
def test_update_liability_mortgages_payment(post_partner_data,get_payment_data_with_case_id,data, field_values,post_system_manager_data, dataa, create_client, post_liability_data,
                                                       post_asset_payment_data, patch_asset_payment_data):
    # Create Client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/Asset_Payment/test_data_asset_payment.csv"))
def test_update_liability_loan_hire_purchase_payments(post_partner_data,get_payment_data_with_case_id,data,post_system_manager_data, dataa, field_values, create_client, post_liability_data,
                                                                 post_asset_payment_data, patch_asset_payment_data):
    # Create Client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    ...
    # # Create loan hire purchase liability
    customer_id = create_client_response['data']['customer_id']
    partner_data = post_partner_data(customer_id, None, "name_and_address", True)
    partner_data_response = partner_data.json()
    logger.info(partner_data_response)
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/Asset_Payment/test_data_asset_payment.csv"))
def test_update_liability_credit_cards_payments(post_partner_data,get_payment_data_with_case_id,data,post_system_manager_data, dataa, field_values, create_client, post_liability_data,
                                                           post_asset_payment_data, patch_asset_payment_data):
    # Create Client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/Asset_Payment/test_data_asset_payment.csv"))
def test_update_policies_life_assurance_payments(post_partner_data,get_payment_data_with_case_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data,
                                                            post_asset_payment_data, patch_asset_payment_data):
    # Create Client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/Asset_Payment/test_data_asset_payment.csv"))
def test_update_policies_pensions_payments(post_partner_data,get_payment_data_with_case_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data,
                                                      post_asset_payment_data, patch_asset_payment_data):
    # Create Client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/Asset_Payment/test_data_asset_payment.csv"))
def test_update_policies_investments_payments(post_partner_data,get_payment_data_with_case_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data,
                                                         post_asset_payment_data, patch_asset_payment_data):
    # Create Client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/Asset_Payment/test_data_asset_payment.csv"))
def test_update_policies_savings_plans_payments(post_partner_data,get_payment_data_with_case_id,data,post_system_manager_data,dataa, field_values, create_client, post_policy_data,
                                                           post_asset_payment_data, patch_asset_payment_data):
    # Create Client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/Asset_Payment/test_data_asset_payment.csv"))
def test_update_policies_income_protection_payments(post_partner_data,get_payment_data_with_case_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data,
                                                               post_asset_payment_data, patch_asset_payment_data):
    # Create Client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/Asset_Payment/test_data_asset_payment.csv"))
def test_update_policies_health_assurance(post_partner_data,get_payment_data_with_case_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data,
                                                     post_asset_payment_data, patch_asset_payment_data):
    # Create Client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    ...
    # # Create health assurance policies
    # provider post
    customer_id = create_client_response['data']['customer_id']
    partner_data = post_partner_data(customer_id, None, "name_and_address", True)
    partner_data_response = partner_data.json()
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/Asset_Payment/test_data_asset_payment.csv"))
def test_update_policies_general_payments(post_partner_data,get_payment_data_with_case_id,data,post_system_manager_data, dataa, field_values, create_client, post_policy_data,
                                                     post_asset_payment_data, patch_asset_payment_data):
    # # Create Client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
