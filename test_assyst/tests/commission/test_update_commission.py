...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/Commission/test_data_asset_payment_commission.csv"))
...
@pytest.mark.parametrize("field_values",
                         common.read_csv("./test_data/Commission/test_data_asset_payment_commission.csv"))
