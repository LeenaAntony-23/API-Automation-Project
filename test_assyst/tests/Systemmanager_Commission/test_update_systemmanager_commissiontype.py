...
# def test_add_data_to_commission_type(data,field_values, post_systemmanager_commissiontype_data,patch_systemmanager_commissiontype_data):
#
...
def test_add_data_to_commission_rule(data,field_values, post_systemmanager_commissiontype_data,patch_systemmanager_commissiontype_data):
