...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/valuations/test_data_valuations.csv"))
def test_update_asset_investment_valuation(post_partner_data,get_valuation_data_with_customer_id,data,post_system_manager_data, dataa, field_values, create_client, post_asset_data, post_valuation_data, patch_valuation_data):
    # Create Client
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/valuations/test_data_valuations.csv"))
def test_update_asset_share_holdings_valuation(post_partner_data,get_valuation_data_with_customer_id,data,post_system_manager_data, dataa, field_values, create_client, post_asset_data, post_valuation_data, patch_valuation_data):
    # Create Client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/valuations/test_data_valuations.csv"))
def test_update_asset_home_personal_valuation(post_partner_data,get_valuation_data_with_customer_id,data,post_system_manager_data, dataa, field_values, create_client, post_asset_data, post_valuation_data,
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/valuations/test_data_valuations.csv"))
def test_update_asset_banks_building_societies_valuation(post_partner_data,get_valuation_data_with_customer_id,data,post_system_manager_data, dataa, field_values, create_client, post_asset_data, post_valuation_data,
                                               patch_valuation_data):
    # Create Client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/valuations/test_data_valuations.csv"))
def test_update_policy_valuation(post_partner_data,get_valuation_data_with_customer_id,post_system_manager_data,dataa,data, field_values, create_client,post_policy_data , post_valuation_data,patch_valuation_data):
    # Create Client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/valuations/test_data_valuations.csv"))
def test_update_policy_pension_valuation(post_partner_data,get_valuation_data_with_customer_id,post_system_manager_data,dataa,data, field_values, create_client,post_policy_data , post_valuation_data,patch_valuation_data):
    # Create Client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/valuations/test_data_valuations.csv"))
def test_update_policies_investments_valuation(post_partner_data,get_valuation_data_with_customer_id,post_system_manager_data,dataa,data, field_values, create_client,post_policy_data , post_valuation_data,patch_valuation_data):
    # Create Client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/valuations/test_data_valuations.csv"))
def test_update_policies_income_protection_valuation(post_partner_data,get_valuation_data_with_customer_id,post_system_manager_data,dataa,data, field_values, create_client,post_policy_data , post_valuation_data,patch_valuation_data):
    # Create Client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/valuations/test_data_valuations.csv"))
def test_update_policies_health_assurance_valuation(post_partner_data,get_valuation_data_with_customer_id,post_system_manager_data,dataa,data, field_values, create_client,post_policy_data , post_valuation_data,patch_valuation_data):
    # Create Client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/valuations/test_data_valuations.csv"))
def test_update_policies_general_valuation(post_partner_data,get_valuation_data_with_customer_id,post_system_manager_data,dataa,data, field_values, create_client, post_policy_data,
