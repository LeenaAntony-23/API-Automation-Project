...
def test_delete_all_data_to_income_client_only(field_values,data,create_client,post_income_data,delete_client_details,get_income_data_with_customer_id):
    # Create client
    ...
    logger.info("First Income Details Deleted Successfully")
    ...
    logger.info("Second Income Details Fetched Successfully")
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_delete_all_data_to_income_client_and_partner(post_partner_data,data,create_client,post_income_data,delete_client_details,get_income_data_with_customer_id):
    # Create client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    logger.info(create_client_response)
    ...
    logger.info(post_income_response)
    common.check_reponse_message(post_income_response, constants.add_income_success_message)
    logger.info("Income Details Added for client Successfully using JSON Data")
    income_id_1 = post_income_response['data']['income_id']
    ...
    income_data = common.read_json("./jsons/create_new_income.json")
    logger.info(income_data)
    income_data['income']['owner'] = 1
    logger.info(income_data)

    post_income = post_income_data(partner_cust_id, income_data, 'income', True)
    post_income_response = post_income.json()
    logger.info(post_income_response)
    common.check_reponse_message(post_income_response, constants.add_income_success_message)
    logger.info("Income Details Added for partner Successfully using JSON Data")
    income_id_2 = post_income_response['data']['income_id']
    ...
    delete_client_data = delete_client_details('income',income_id_2)
    delete_client_response = delete_client_data.json()
    logger.info(delete_client_response)
    common.check_reponse_message(delete_client_response, constants.delete_income_success_message)
    ...
    total_before = get_client_response_before['data']['total']
    total_after = get_client_response_after['data']['total']
    assert total_after['PartnerAnnualGrossAmount'] < total_before['PartnerAnnualGrossAmount'], "PartnerAnnualGrossAmount should be zero after deletion"


@pytest.mark.parametrize("data",["./jsons/create_client.json"])
@pytest.mark.parametrize("field_values", common.read_csv("./test_data_regression/Income/test_data_income.csv"))
def test_delete_all_data_single_income(field_values,data,create_client,post_income_data,delete_client_details,get_income_data_with_customer_id):
    # Create client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    logger.info(create_client_response)
    ...
    get_client_response_before = get_income_details.json()
    logger.info(get_client_response_before)
    common.check_reponse_message(get_client_response_before, constants.get_income_not_found_message)
    logger.info("Income Details not fetched")
