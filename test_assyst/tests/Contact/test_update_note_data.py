...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/Client/test_data_contacts_notes.csv"))
def test_update_contacts_notes_data(datas,field_values, create_client, post_client_note_data, patch_note_data):
