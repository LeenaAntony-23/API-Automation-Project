...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/Client/test_data_contacts_client_action.csv"))
def test_update_appointment_data(data, field_values, create_client, post_client_data, patch_appointment_data):
