...
def test_fetch_factfind_summary(post_system_manager_data,dataa,get_factfind_summary_report,post_policy_data,post_liability_data, create_client,post_asset_data,post_outgoing_data,post_income_data,data,post_partner_data,post_dependant_data,post_client_data):
...
#get function
    get_user_info = get_factfind_summary_report(customer_id)
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_fact_summary_invalid_context(get_fact_summary_invalid_context,data,create_client,post_partner_data):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
...
# post partner
    ...
    common.check_reponse_message(partner_data_response, constants.add_partner_success_message)
    logger.info("Partner Details Added Successfully")
    get_user_info = get_fact_summary_invalid_context(customer_id)
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_fact_summary_empty_custid(get_fact_summary_empty_custid,data,create_client,post_partner_data):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
    ...
    get_user_info = get_fact_summary_empty_custid()
    get_user_details_response = get_user_info.json()
    logger.info(get_user_details_response)
    logger.info("Invalid Customer Id")

def test_fetch_fact_summary_mutitenant_custid(get_factfind_summary_report,post_partner_data):
