...
def test_add_data_to_user_defined( post_system_manager_data,create_client,data,dataa,post_userdefined_value):
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_add_data_to_user_defined_invalid_userfield_id(post_system_manager_data, create_client, data, dataa,
