...
@pytest.mark.parametrize("field_values", common.read_csv("./test_data/AttitudeRisk/test_data_attitude_risk.csv"))
def test_add_all_data_to_attitude_risk(data, field_values, create_client, post_client_data):
