...
def test_fetch_contact_history_data_with_valid_customer_id(post_client_fact_note_data,post_system_manager_data,dataa,data, create_client, post_fact_findnotes_outgoing_data_with_customer_id,post_asset_data, post_business_data,post_client_data, get_contact_history_data_with_customer_id):
    ...
    client_asset = post_asset_data(customer_id,provider_correspondence_id, None, 'asset_investment_asset', True)
