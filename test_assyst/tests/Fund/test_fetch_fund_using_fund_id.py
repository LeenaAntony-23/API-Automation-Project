...
def test_fetch_asset_fund_data_with_fund_id(post_partner_data,data,post_system_manager_data, dataa, create_client, post_asset_data,post_fund_data,get_fund_data_with_fund_id):
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_policies_life_assurance_fund_data_with_fund_id(post_partner_data,post_system_manager_data,dataa,data, create_client, post_policy_data,post_fund_data,get_fund_data_with_fund_id):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_policies_pensions_fund_data_with_fund_id(post_partner_data,post_system_manager_data,dataa,data, create_client, post_policy_data,post_fund_data,get_fund_data_with_fund_id):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_policies_investments_fund_data_with_fund_id(post_partner_data,post_system_manager_data,dataa,data, create_client, post_policy_data,post_fund_data,get_fund_data_with_fund_id):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_policies_savings_plans_fund_data_with_fund_id(post_partner_data,post_system_manager_data,dataa,data, create_client, post_policy_data,post_fund_data,get_fund_data_with_fund_id):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_policies_income_protection_fund_data_with_fund_id(post_partner_data,post_system_manager_data,dataa,data, create_client, post_policy_data,post_fund_data,get_fund_data_with_fund_id):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_policies_health_assurance_fund_data_with_fund_id(post_partner_data,post_system_manager_data,dataa,data, create_client, post_policy_data,post_fund_data,get_fund_data_with_fund_id):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
...
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_policies_general_fund_data_with_fund_id(post_partner_data,post_system_manager_data,dataa,data, create_client, post_policy_data,post_fund_data,get_fund_data_with_fund_id):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_policies_general_fund_data_with_invalid_fund_id(data, create_client, post_policy_data,post_fund_data,get_fund_data_with_fund_id):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
