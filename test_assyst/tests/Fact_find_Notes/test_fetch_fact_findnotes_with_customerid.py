...
def test_fetch_one_factnote_data_with_valid_customer_id(post_client_fact_note_data,data, create_client,get_fact_find_notes_data_with_customer_id,post_fact_findnotes_outgoing_data_with_customer_id):
