...
def test_update_data_to_expense_category(data,field_values, post_system_manager_data, patch_system_data):
...
def test_update_data_to_income_category(data,field_values, post_system_manager_data, patch_system_data):
...
def test_update_data_to_attitude_category(data,field_values, post_system_manager_data, patch_system_data):
...
def test_update_data_to_attitude_rating_category(data,field_values, post_system_manager_data, patch_system_data):
...
def test_update_data_to_objective_detail_category(data,field_values, post_system_manager_data, patch_system_data):
...
def test_update_data_to_provider_detail_category(data,field_values, post_system_manager_data, patch_system_data):
...
def test_update_data_to_standard_clientaction_category(data,field_values, post_system_manager_data, patch_system_data):
...
def test_update_data_to_user_defined(data,field_values, post_system_manager_data, patch_system_data):
