...
def test_fetch_asset_data_with_valid_asset_id(post_partner_data,data,post_system_manager_data, dataa, create_client, post_asset_data, get_case_summary_asset_data_with_customer_id):
