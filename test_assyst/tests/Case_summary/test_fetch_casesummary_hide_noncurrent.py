...
def test_fetch_show_non_current(post_partner_data,post_policy_data,post_liability_data,data,post_system_manager_data, dataa, create_client, post_asset_data, get_case_summary_hide_noncurrent):
