...
def test_fetch_asset_action_data_with_case_id(post_partner_data,data,post_system_manager_data, dataa, create_client, post_asset_data, post_business_data,
                                              get_business_casesummary_data_with_case_id):
    ...
    get_action_data = get_business_casesummary_data_with_case_id(asset_id, customer_id)
    ...
    logger.info("Action Details For Investment CaseSummary Fetched Successfully")

    common.compare_dicts(post_asset_investment_response['data'], get_action_response['data'])
    logger.info("Fetch Action Data CaseSummary With Case Id Test Passed!")


@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_mortgages_action_data_with_case_id(post_partner_data,data, post_system_manager_data, dataa, create_client, post_liability_data, post_business_data,
                                                  get_business_casesummary_data_with_case_id):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    ...
    get_action_data = get_business_casesummary_data_with_case_id(liability_id, customer_id)
    get_action_response = get_action_data.json()
    common.check_reponse_message(get_action_response, constants.get_business_case_id_success_message)
    assert get_action_response["isError"] is False
    logger.info("Action Details For Mortgages CaseSummary Fetched Successfully")

    common.compare_dicts(post_liability_mortgage_response['data'], get_action_response['data'])
    logger.info("Fetch Mortgages Action Data CaseSummary With Case Id Test Passed!")


@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_loan_hire_action_data_with_case_id(post_partner_data,data,post_system_manager_data, dataa, create_client, post_liability_data, post_business_data,
                                                  get_business_casesummary_data_with_case_id):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    ...
    liability_id = create_liability_response['data']['liability_id']
    post_liability_loan_hire = post_business_data(customer_id, liability_id, None,'liabilities_loan_hire_purchase_actions', True)
    ...
    common.check_reponse_message(get_action_response, constants.get_business_case_id_success_message)
    assert get_action_response["isError"] is False
    logger.info("Action CaseSummary  Details For Loan Hire Fetched Successfully")

    common.compare_dicts(post_liability_loan_hire_response['data'], get_action_response['data'])
    logger.info("Fetch Loan Hire Action Data CaseSummary With Case Id Test Passed!")


@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_life_assurance_action_data_with_case_id(post_partner_data,data,post_system_manager_data, dataa, create_client, post_policy_data, post_business_data,
                                                       get_business_casesummary_data_with_case_id):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    ...
    get_action_data = get_business_casesummary_data_with_case_id(policy_id, customer_id)
    get_action_response = get_action_data.json()
    common.check_reponse_message(get_action_response, constants.get_business_case_id_success_message)
    assert get_action_response["isError"] is False
    logger.info("Action Details CaseSummary For Life Assurance Fetched Successfully")

    common.compare_dicts(post_policy_life_assurance_response['data'], get_action_response['data'])
    logger.info("Fetch Life Assurance Action Data CaseSummary With Case Id Test Passed!")


@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_pensions_action_data_with_case_id(post_partner_data,data,post_system_manager_data, dataa,create_client, post_policy_data, post_business_data,
                                                 get_business_casesummary_data_with_case_id):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    ...
    common.check_reponse_message(get_action_response, constants.get_business_case_id_success_message)
    assert get_action_response["isError"] is False
    logger.info("Action Details CaseSummary For Pensions Fetched Successfully")

    common.compare_dicts(post_policy_pensions_response['data'], get_action_response['data'])
    logger.info("Fetch Pensions Action Data CaseSummary With Case Id Test Passed!")


@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_investment_action_data_with_case_id(post_partner_data,data, post_system_manager_data, dataa,create_client, post_policy_data, post_business_data,
                                                   get_business_casesummary_data_with_case_id):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    ...
    common.check_reponse_message(get_action_response, constants.get_business_case_id_success_message)
    assert get_action_response["isError"] is False
    logger.info("Action Details CaseSummary For Investment Fetched Successfully")

    common.compare_dicts(post_policy_investment_response['data'], get_action_response['data'])
    logger.info("Fetch Investment Action Data CaseSummary With Case Id Test Passed!")


@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_savings_plan_action_data_with_case_id(post_partner_data,data,post_system_manager_data, dataa, create_client, post_policy_data, post_business_data,
                                                     get_business_casesummary_data_with_case_id):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    ...
    common.check_reponse_message(get_action_response, constants.get_business_case_id_success_message)
    assert get_action_response["isError"] is False
    logger.info("Action Details CaseSummary For Savings Plan Fetched Successfully")

    common.compare_dicts(post_policy_investment_response['data'], get_action_response['data'])
    logger.info("Fetch Savings Plan Action Data CaseSummary With Case Id Test Passed!")


@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_income_protection_action_data_with_case_id(post_partner_data,data,post_system_manager_data, dataa, create_client, post_policy_data,
                                                          post_business_data, get_business_casesummary_data_with_case_id):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
    ...
    common.check_reponse_message(get_action_response, constants.get_business_case_id_success_message)
    assert get_action_response["isError"] is False
    logger.info("Action Details CaseSummary For Income Protection Fetched Successfully")

    common.compare_dicts(post_policy_income_protection_response['data'], get_action_response['data'])
    logger.info("Fetch Income Protection Action Data CaseSummary With Case Id Test Passed!")
...
def test_fetch_health_assurance_action_data_with_case_id(post_partner_data,data,post_system_manager_data, dataa, create_client, post_policy_data,
    ...
    common.check_reponse_message(get_action_response, constants.get_business_case_id_success_message)
    assert get_action_response["isError"] is False
    logger.info("Action Details CaseSummary For Health Assurance Fetched Successfully")

    common.compare_dicts(post_policy_health_assurance_response['data'], get_action_response['data'])
    logger.info("Fetch Health Assurance Action Data CaseSummary With Case Id Test Passed!")


@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_general_action_data_with_case_id(post_partner_data,data, post_system_manager_data, dataa,create_client, post_policy_data, post_business_data,
                                                get_business_casesummary_data_with_case_id):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
def test_fetch_business_action_with_invalid_case_id(data, create_client, get_business_casesummary_data_with_case_id):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
    ...
    customer_id = create_client_response['data']['customer_id']
    get_action_data = get_business_casesummary_data_with_case_id('e34960f1-ce23-4985-a5df-d497193be3ab', customer_id)
    get_action_response = get_action_data.json()
...
@pytest.mark.parametrize("data", ["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_fetch_business_action_with_invalid_customer_id(post_partner_data,data,post_policy_data,post_business_data, post_system_manager_data, dataa,create_client, get_business_casesummary_data_with_case_id):
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    common.check_reponse_message(create_client_response, constants.add_client_success_message)
    logger.info("Client Details Added Successfully")
    ...
    customer_id = create_client_response['data']['customer_id']
    get_action_data = get_business_casesummary_data_with_case_id(policy_id, 'e34960f1-ce23-4985-a5df-d497193be3ab')
    get_action_response = get_action_data.json()
    common.check_reponse_message(get_action_response, constants.invalid_case_id_message)
    assert get_action_response["isError"] is False
    logger.info("Fetch Action Data CaseSummary With Invalid Case ID Test Passed!")