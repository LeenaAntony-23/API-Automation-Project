...
def test_delete_all_data_to_single_asset_investment(dataa,data,post_system_manager_data,create_client,post_asset_data,delete_case_details,get_asset_data_with_customer_id):
    # Create client
    ...
    #  Delete first asset details
    delete_client_data = delete_case_details('asset',asset_id)
...
@pytest.mark.parametrize("data",["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_delete_all_data_to_multiple_asset_investment(dataa,post_system_manager_data,data,create_client,post_asset_data,delete_case_details,get_asset_data_with_customer_id):
    # Create client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    logger.info(create_client_response)
    ...
    delete_client_data = delete_case_details('asset',asset_id_1)
    delete_client_response = delete_client_data.json()
    logger.info(delete_client_response)
    common.check_reponse_message(delete_client_response, constants.delete_asset_success_message)
...
@pytest.mark.parametrize("data",["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_delete_all_data_to_single_asset_share_holding(dataa,data,post_system_manager_data,create_client,post_asset_data,delete_case_details,get_asset_data_with_customer_id):
    # Create client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    logger.info(create_client_response)
...
@pytest.mark.parametrize("data",["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_delete_all_data_to_multiple_asset_share_holding(dataa,post_system_manager_data,data,create_client,post_asset_data,delete_case_details,get_asset_data_with_customer_id):
    # Create client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    logger.info(create_client_response)
...
@pytest.mark.parametrize("data",["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_delete_all_data_to_single_asset_home_personal(dataa,data,post_system_manager_data,create_client,post_asset_data,delete_case_details,get_asset_data_with_customer_id):
    # Create client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    logger.info(create_client_response)
...
@pytest.mark.parametrize("data",["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_delete_all_data_to_multiple_asset_home_personal(dataa,post_system_manager_data,data,create_client,post_asset_data,delete_case_details,get_asset_data_with_customer_id):
    # Create client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    logger.info(create_client_response)
...
@pytest.mark.parametrize("data",["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_delete_all_data_to_single_asset_banks_building_societies(dataa,data,post_system_manager_data,create_client,post_asset_data,delete_case_details,get_asset_data_with_customer_id):
    # Create client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    logger.info(create_client_response)
...
@pytest.mark.parametrize("data",["./jsons/create_client.json"])
@pytest.mark.parametrize("dataa", ["./jsons/create_new_systemmanager.json"])
def test_delete_all_data_to_multiple_asset_banks_building_societies(dataa,post_system_manager_data,data,create_client,post_asset_data,delete_case_details,get_asset_data_with_customer_id):
    # Create client
    create_client = create_client(data, None, True)
    create_client_response = create_client.json()
    logger.info(create_client_response)
